          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">Dashboard AJK masjid</div>
                    <div className="text-gray-600">Lihat informasi dan status terkini masjid di dalam satu laman yang kemas dan teratur.</div>
                  </div>
                ...
                >
                  <div>
                    <div className="font-bold leading-snug tracking-tight mb-1">Portal kariah</div>
                    <div className="text-gray-600">Mudahkan anak kariah untuk berurusan dengan pihak masjid.</div>
                  </div>
                  <div className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3">
                    <svg className="w-3 h-3 fill-current" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="relative flex flex-col text-center lg:text-right" data-aos="zoom-y-out" ref={tabs}>
                  ...
                  >
                    <div className="relative inline-flex flex-col w-full">
                      <img className="md:max-w-none mx-auto rounded" src="/images/feature1.png" width={500} height={462} alt="Features bg" />
                  ...
                  >
                    <div className="relative inline-flex flex-col w-full">
                      <img className="md:max-w-none mx-auto rounded" src="/images/feature2.png" width={500} height={462} alt="Features bg" />
                      {/* <img className="md:max-w-none absolute w-full left-0 transform animate-float" src={FeaturesElement} width={500} height="44" alt="Element" style={{ top: '30%' }} /> */}
                    </div>
                  </Transition>
                  {/* Item 3 */}
