      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Modul yang terkandung di E-Masjid setakat ini</h2>
            <p className="text-xl text-gray-600">Semua modul dibangunkan berdasarkan permintaan popular.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">E-Khairat</h4>
              <p className="text-gray-600 text-center">Pengurusan khairat dalam talian yang boleh di akses di mana sahaja.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Tabung</h4>
              <p className="text-gray-600 text-center">Penyata kutipan tabung mengikut garis panduan JAKIM.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Peti Aduan/Cadangan</h4>
              <p className="text-gray-600 text-center">Pengurusan aduan/cadangan dalam talian yang mudah dan cepat.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">E-Korban</h4>
              <p className="text-gray-600 text-center">Akan datang...</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Mesyuarat</h4>
              <p className="text-gray-600 text-center">Akan datang...</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Surat Keluar/Masuk</h4>
              <p className="text-gray-600 text-center">Akan datang...</p>
            </div>
